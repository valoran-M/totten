...
class Pourcb:
    ...
    async def launch(self, client):
        ...
        await self.mention1.send(f"Donne un nombre entre 1 et 10")  
        await self.author.send(f"Donne un nombre entre 1 et 10") #mention2->author
        ...
        print(rep1,rep2)
        if rep1 == rep2:
            await self.channel.send(f'Gagné, vous avez tous les deux choisi {rep1}')
        else :
